  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        crm: ['"Geist"', '"Public Sans"', 'system-ui', 'sans-serif'],
        'crm-display': ['"Fraunces"', '"Recoleta"', 'Georgia', 'serif'],
        'crm-body': ['"Geist"', '"Public Sans"', 'system-ui', 'sans-serif'],
        'crm-label': ['"Geist"', '"Epilogue"', 'sans-serif'],
