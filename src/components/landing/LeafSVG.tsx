...
const LeafSVG: React.FC<LeafSVGProps> = ({ size = 24, id = 'leaf', className, style }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none" className={className} style={style}>
    ...
    <path
      ...
      opacity="0.85"
    />
    <path d="M16 6V26" stroke="hsl(125 47% 28%)" strokeWidth="0.6" opacity="0.45" />
    <path d="M16 10C13 13 10 16 8 19" stroke="hsl(125 47% 28%)" strokeWidth="0.4" opacity="0.24" />
    <path d="M16 14C19 16 22 18 24 20" stroke="hsl(125 47% 28%)" strokeWidth="0.4" opacity="0.24" />
    <defs>
