...
const STATUS_MAP: Array<{ keywords: string[]; status: LeadStatus }> = [
  ...
  { keywords: ['contato', 'contatando', 'abordagem', 'contacting', 'emcontato'], status: LEAD_STATUS.CONTACTING },
  { keywords: ['negociacao', 'negociando', 'aguardando', 'proposta', 'orcamento', 'pendente'], status: LEAD_STATUS.NEGOTIATING },
  { keywords: ['cliente', 'fechado', 'comprou', 'ganho', 'vendido', 'won', 'venda', 'pago'], status: LEAD_STATUS.WON },
  { keywords: ['perdido', 'naorespondeu', 'semresposta', 'desistiu', 'lost', 'cancelado'], status: LEAD_STATUS.LOST },
];
